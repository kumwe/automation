...
This is a source extraction PR, not a release attestation. Publication is blocked pending independently verified immutable dependencies, including CanonicalEncoder in kumwe/canonical-json >=0.1.1. Current development consumers use explicitly identified local source snapshots; they do not establish registry availability, security-audit completeness or host adoption. App wiring must remain unchanged until dependency publication, exact release verification and separately reviewed adoption. Do not merge, tag or publish as part of this work.
