...
The package contains 24 portable public types. Worker loops, OS signals and RuntimeDeadline enforcement, scheduler execution, trusted handler selection, database coordination and lifecycle remain App-owned.
